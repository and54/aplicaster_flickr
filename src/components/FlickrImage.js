...
export default class FlickrImage extends Component {
  ...
  componentDidMount() {
    fetch('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key='+process.env.REACT_APP_FLICKR_KEY+'&tags='+this.state.search+'&per_page=100&page=1&format=json&nojsoncallback=1')
    .then(response => response.json())
    .then(json => this.addPhotos(json.photos.photo));
  };
